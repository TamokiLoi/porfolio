...
const About = () => {
    ...
    return (
        <>
            ...
            <p>
                Hi, my name <strong className="text-light-gray">Tamoki Loi</strong> (
                <span className="text-light-gray">Nguyen Lam Thanh Loi</span>), {"I'm"} a Frontend Developer and I enjoy
            ...
            <p>
                ...
                <span className="text-light-green">a huge corporation</span> and currently{" "}
